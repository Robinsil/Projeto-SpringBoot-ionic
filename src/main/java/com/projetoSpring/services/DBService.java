...
import com.projetoSpring.domain.Pagamento;
import com.projetoSpring.domain.PagamentoComBoleto;
import com.projetoSpring.domain.PagamentoComCartao;
...
public class DBService {
	...
	public void instantiateTestDataBase() throws ParseException {
		...
		Categoria cat8 = new Categoria(null, "Esportivos");
		...
		Cidade c1 = new Cidade(null,"Uberlan dia",est1);
		...
		Cliente cli1 = new Cliente(null," Maria Silva","robinrodsilva@gmail.com" ,"35503131878", TipoCliente.PESSOAFISICA,pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("5823-0191","58240292"));
		
		Cliente cli2 = new Cliente(null," Ana Costa","robinsil@outlook.com" ,"562.597.340-77", TipoCliente.PESSOAFISICA,pe.encode("123"));
        cli2.addPerfil(Perfil.ADMIN);
        cli1.getTelefones().addAll(Arrays.asList("5823-0191","58240292"));
		
		Endereco e1 = new Endereco(null,"Rua Flores ", "300", "Apto 303","Jardim","058-154790",cli1, c1);
		
		Endereco e2 = new Endereco(null, "Avenida Matos","105","Sala 800","Centro","3877712",cli1, c2);
		
		Endereco e3 = new Endereco(null, "Avenida Floriano","105",null,"Centro","3877712",cli2, c2);
